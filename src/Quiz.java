...
public class Quiz implements ActionListener {
    ...
    String[][] options =    {
                                ...
                                {"Steve Jobs", "Bil Gates", "James Gosling", "Mark Zuckerberg"}
                            };
    ...
    public Quiz(){
        ...
        buttonB.addActionListener(this);buttonA.setBounds(0,100,100,100);
        buttonB.setText("B");

        buttonC.setBounds(0,300,100,100);
        buttonC.setFont(new Font("MV Boli",Font.BOLD,35));
        buttonC.setFocusable(false);
        buttonC.addActionListener(this);buttonA.setBounds(0,100,100,100);
        buttonC.setText("C");
